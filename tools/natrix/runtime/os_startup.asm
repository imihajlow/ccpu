    ...
    .global __seg_syscall_text_begin
    .global __seg_syscall_text_end
    .global __seg_syscall_text_origin_begin
    .global __seg_syscall_text_origin_end
    ...
    ; populate syscall secion
    ldi pl, lo(memcpy_arg0)
    ldi ph, hi(memcpy_arg0)
    ldi a, lo(__seg_syscall_text_begin)
    ldi b, hi(__seg_syscall_text_begin)
    st a
    inc pl
    st b
    ...
    ldi pl, lo(memcpy_arg1)
    ldi ph, hi(memcpy_arg1)
    ldi a, lo(__seg_syscall_text_origin_begin)
    ldi b, hi(__seg_syscall_text_origin_begin)
    st a
    inc pl
    st b
    ...
    ldi pl, lo(memcpy_arg2)
    ldi ph, hi(memcpy_arg2)
    ldi a, lo(__seg_syscall_text_end - __seg_syscall_text_begin)
    ldi b, hi(__seg_syscall_text_end - __seg_syscall_text_begin)
    st a
    inc pl
    st b
