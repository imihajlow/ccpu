...
#define CHAR_KEY '?'
#define CHAR_KEY_STATIC '?'
#define CHAR_EXIT 'E'
#define CHAR_EXIT_STATIC 'E'
#else
#define CHAR_WALL 0xffu8
#define CHAR_PASSAGE_UP 0x0au8
#define CHAR_PASSAGE_DN 0x08u8
#define CHAR_PASSAGE_UPDN ' '
#define CHAR_PASSAGE 0x09u8

#define CHAR_PLAYER 0x0bu8

#define CHAR_KEY 0x0cu8
#define CHAR_KEY_STATIC 0xd2u8
#define CHAR_EXIT 0x0du8
#define CHAR_EXIT_STATIC 0xfcu8
#endif
